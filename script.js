...
let projects = [
    ...
    {parts: ["All","Front End", "wiuehjdiuewjhfiouwejf"], img: "9.png", title: "Sign in to smarix", text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda deleniti reprehenderit debitis pariatur sequi facilis libero explicabo veniam tempore dolore?"},
]
...
function appendCards( activePart ) {
    ...
    for( let part of parts ) {
     projectsNav.append( button({ class: part == activePart ? "active" : "", text: part, onclick: `appendCards('${part}')` }) ) }
...
//     projectsNav.innerHTML = ""
//     for ( let part of parts){
//         projectsNav.append(button({class: part == activepart ? "activd" : "", text: part, onclick: `appendCards('${part}')` }) ) }

//     let projectsParent= document.querySelector(".projects .cards")    
//     projectsParent.innerHTML=""
//     for(let project of projects){
//         if (project.parts.includes(activepart)) {
//             projectsParent.append(div({class:"project", children:[ img({src:'media/'+project.img}), h2({text:"project.title"}),p({text:project.text}),button({text:"view Project"})]}))
//         }
//     }
// }
